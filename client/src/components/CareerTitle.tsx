      ...
      <section className="bg-white">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-bold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-black">
              Find Jobs
            </h1>
            ...
            <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
              <button
                onClick={onJobOpeningsClick} // Trigger the scroll function here
                className="px-6 py-3 bg-[#F05924] text-white font-semibold text-lg rounded-lg shadow-lg hover:bg-[#E04D1F] hover:shadow-xl transition duration-300 focus:outline-none focus:ring-2 focus:ring-[#F05924] focus:ring-offset-2"
              >
                Job Openings
              </button>
            </div>
